...
#### 1. br태그 (<br>, 닫히는 태그 존재X)

#### 2. p태그 (<p></p>)

#### 두 태그의 공통점: 둘 다 줄바꿈 할때 사용되는 태그임

#### 두 태그의 차이점: 정해진 줄 바꿈간격이 있는 <p></p>와 달리 <br>은 한번쓰면 한번 띄워지고, 두번쓰면 두번 띄워지는 식으로 작동, 단락을 나눠줄때는 <p></p>를 사용해주는 게 더 좋음 (닫히는태그가 있기 때문에 한 단락임을 알아보기 유용)
...
#### 순서 있는 리스트의 경우: <li></li> 를 <ol></ol>로 감싸주기

#### 순서 없는 리스트의 경우: <li></li> 를 <ul></ul>로 감싸주기
